...
<template>
	<div
		class="sm:px-0 md:px-5 lg:px-10 xl:px-10 sm:py-0 md:py-1 lg:py-3 xl:lg:py-3 flex flex-col gap-10 bg-surface-50 dark:bg-surface-950">
		<Header />
				...
				<div>
					<div class="card">
						<DataTable
							...
							<Column
								field="code"
								header="Bill Date"></Column>
							<Column
								field="name"
								header="Water Bill"></Column>
							<Column
								field="category"
