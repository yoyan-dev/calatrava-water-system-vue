...
function onSubmit () {
    // toast.add({severity:'success', summary: 'Successful', detail: 'waterBill Updated', life: 3000});
...
<template>
    <div>
        ...
        <Dialog v-model:visible="isOpen" :style="{ width: '450px' }" header="Water Bill Details" :modal="true">
            <div class="flex flex-col gap-6">
                ...
                <div>
                    ...
                    <!-- <small v-if="submitted && !waterBill.name" class="text-red-500">Name is required.</small> -->
                </div>
                <div>
